...
This is an example plugin folder. It acts strictly as a **metadata registry** for your plugin. Your actual plugin source code should be hosted in your own separate repository.
